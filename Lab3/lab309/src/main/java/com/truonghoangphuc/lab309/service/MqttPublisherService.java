package com.truonghoangphuc.lab309.service;
	...
	public void publish(String topic, String message) {
		...
		mqttOutboundChannel.send(
				MessageBuilder.withPayload(message)
						...
						.build());
		// Lưu lịch sử vào PostgreSQL sau khi publish thành công
		mqttMessageRepository.save(new MqttMessage(topic, message, LocalDateTime.now()));
	}
}
