...
class LampConnectScreen extends StatefulWidget {
  const LampConnectScreen({super.key});

  @override
  State<LampConnectScreen> createState() => _LampConnectScreenState();
}

class _LampConnectScreenState extends State<LampConnectScreen> {
  @override
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Center(
                  child: Image.asset(
                    'assets/images/OOjs_UI_icon_lightbulb-yellow.svg.png',
                    width: 160,
                    height: 160,
                    fit: BoxFit.contain,
                  ),
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      Navigator.of(context).push(
                        MaterialPageRoute(
                          builder: (_) => const WifiScanScreen(deviceId: 'manual'),
                        ),
                      );
                    },
